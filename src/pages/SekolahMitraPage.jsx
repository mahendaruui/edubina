...
const SekolahMitraPage = ({ sekolahMitra }) => {
  ...
  return (
    ...
    >
      ...
      <motion.p
        className="text-lg text-gray-700 max-w-2xl mx-auto mb-12 text-center"
      ...
      >
        {sekolahMitra.map((sekolah, index) => (
          <motion.div
            ...
            className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg border border-indigo-100 transition-all duration-300 transform hover:-translate-y-1.5 flex flex-col justify-between"
          >
            <div>
              <div className="flex items-center mb-4">
                <div className="p-3 bg-gradient-to-br from-indigo-500 to-pink-500 rounded-lg mr-4 shadow-sm">
                  <School className="h-6 w-6 text-white" />
                </div>
                <h2 className="text-xl font-semibold text-gray-800">{sekolah.name}</h2>
              </div>
