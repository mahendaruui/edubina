...
const SmaNegeri08BandaAcehPage = () => {
  ...
  <Button asChild variant="outline" className="mb-8 group text-indigo-600 border-indigo-500 hover:bg-indigo-50 hover:text-indigo-800 transition-colors duration-300">
        ...
        <header className="mb-10 md:mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 pb-2">
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-start mb-12 md:mb-16">
        <motion.div variants={sectionVariants} initial="hidden" animate="visible">
          <img
           ...
           src="https://sman8bna.wordpress.com/wp-content/uploads/2017/11/123.jpg" />
        </motion.div>
        <motion.div variants={sectionVariants} initial="hidden" animate="visible" className="space-y-6">
          <h2 className="text-3xl font-semibold text-green-600 mb-4">Profil Sekolah</h2>
      ...
      >
        <h2 className="text-3xl font-semibold text-emerald-600 mb-8 text-center">Program Unggulan</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            >
              <div className="p-3 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full mb-4 shadow-sm">
                {feature.icon}
              </div>
      ...
      <motion.div variants={sectionVariants} initial="hidden" animate="visible" className="text-center">
        ...
        <Button size="lg" className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-semibold px-8 py-3 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
