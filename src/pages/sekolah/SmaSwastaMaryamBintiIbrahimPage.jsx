    ...
    >
      <motion.div variants={sectionVariants} initial="hidden" animate="visible">
        ...
        <header className="mb-10 md:mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 via-cyan-500 to-sky-500 pb-2">
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-start mb-12 md:mb-16">
        ...
        <motion.div variants={sectionVariants} initial="hidden" animate="visible" className="space-y-6">
          <h2 className="text-3xl font-semibold text-teal-300 mb-4">Profil Sekolah</h2>
      ...
      >
        <h2 className="text-3xl font-semibold text-cyan-400 mb-8 text-center">Program Unggulan</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-slate-800/70 p-6 rounded-xl shadow-lg hover:shadow-cyan-500/20 transition-shadow duration-300 flex flex-col items-center text-center glassmorphism-card"
            >
              <div className="p-3 bg-gradient-to-br from-cyan-500 to-sky-500 rounded-full mb-4 shadow-md">
                {feature.icon}
              </div>
      ...
      <motion.div variants={sectionVariants} initial="hidden" animate="visible" className="text-center">
        ...
        <Button size="lg" className="bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white font-semibold px-8 py-3 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
          Hubungi Sekolah
        </Button>
      </motion.div>
    </motion.div>
