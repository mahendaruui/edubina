    ...
    >
      <motion.div variants={sectionVariants} initial="hidden" animate="visible">
        ...
        <header className="mb-10 md:mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-amber-500 via-orange-600 to-red-600 pb-2">
      ...
      >
        <h2 className="text-3xl font-semibold text-orange-600 mb-8 text-center">Program Keahlian Unggulan</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            >
              <div className="p-3 bg-gradient-to-br from-orange-500 to-red-500 rounded-full mb-4 shadow-sm">
                {feature.icon}
              </div>
      ...
      <motion.div variants={sectionVariants} initial="hidden" animate="visible" className="text-center">
        ...
        <Button size="lg" className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold px-8 py-3 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300">
          Info Pendaftaran
        </Button>
      </motion.div>
    </motion.div>
